        ...
        {products.map((product) => (
          <div key={product.id} id={product.id} className='scroll-m-12 pt-10'>
            <div className='flex flex-col gap-8 rounded-lg border bg-muted p-8 md:flex-row'>
              <Image src={product.image} height={40} width={80} alt='Logo' className='h-fit w-[100px] dark:hidden' />
              <Image
              ...
              <div className='flex flex-auto flex-col'>
                <div className='max-w-lg'>
                  ...
                  <dd className='mt-2 text-base leading-normal text-muted-foreground'>{product.description}</dd>
                </div>
              </div>
