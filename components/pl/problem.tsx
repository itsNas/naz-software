  ...
  return (
    <section id='problem' className='border-b border-neutral-700 pb-16 pt-32 lg:pb-24'>
      <div className='max-w-3xl'>
        <p className='mb-6 inline-block rounded-full border border-yellow-500 bg-yellow-700/20 px-3 py-1 text-sm leading-7 text-yellow-300'>
          Il problema
        </p>
        <h2 className='text-3xl font-extrabold text-white lg:text-5xl lg:leading-tight'>
          ...
          <span className='inline-block leading-10 underline decoration-yellow-400 underline-offset-4'>Ca***te</span>.
        </h2>
      </div>

      <div className='mt-8 flex flex-col justify-between sm:flex-row'>
        <p className='font-light text-neutral-400 sm:w-8/12 lg:text-lg'>
          Se cerchi su Google come imparare a programmare, finisci con avere più domande che risposte. È normale essere
          disorientati, ci siamo passati tutti.
          <br /> <br />
          A scuola, in università e online ci fanno credere che la programmazione sia per pochi eletti, con elevate
          capacità logiche e matematiche.
          <br /> <br />
          La verità è che tutti possono imparare a programmare, basta avere il metodo giusto e una guida che ti mostri{" "}
          <span className='underline decoration-yellow-400 underline-offset-4'>il percorso corretto da seguire.</span>
        </p>
