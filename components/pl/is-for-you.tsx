          ...
          <ul className='my-6 space-y-5 border-neutral-700 md:border-t md:pt-8'>
            {forYouIf.map((item) => (
              <li className='flex space-x-3' key={item}>
                ...
                <span className='text-base font-medium leading-tight text-neutral-900 dark:text-white'>{item}</span>
              </li>
            ))}
          </ul>
          <p className='text-neutral-500 dark:text-neutral-400 lg:text-lg'>
            Programmatore Leggendario è il corso perfetto per chi vuole imparare a programmare e vuole una guida pratica
            e chiara.
          </p>
        </div>
