  ...
  return (
    <section id='solution' className='space-y-16 pt-16 text-neutral-400 sm:text-lg md:space-y-32 lg:pb-8 lg:pt-24'>
      <div>
        <div className='max-w-3xl'>
          ...
          <p className='mt-4 font-light lg:text-xl'>
            Ho creato questo corso per consentire a chiunque di imparare a programmare e sviluppare la mentalità del
            programmatore di successo.
          </p>
        </div>
      ...
      <div>
        <div className='max-w-3xl'>
          <h2 className='text-3xl font-extrabold tracking-tight text-neutral-900 dark:text-white lg:text-5xl'>
            Saprai come <span className='underline decoration-yellow-400 underline-offset-4'>creare un’app</span>, un
            sito web o videogame.
          </h2>
          <p className='mt-4 font-light lg:text-xl'>
            Ti insegniamo tutte le nozioni chiave della programmazione che ti servono per realizzare qualunque tuo
            progetto o idea.
          </p>
        </div>
