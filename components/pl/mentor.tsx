    ...
    <section id='mentor' className='lg:pt-8'>
      ...
      <div className='flex flex-col justify-between md:flex-row'>
        <p className='my-8 text-neutral-600 dark:text-neutral-400 md:w-6/12 lg:text-lg'>
          A 17 anni avevo un sogno: creare un social network, un po' come Facebook. Dopo poco ho realizzato che ne la
          scuola, ne l'università mi avrebbero aiutato a realizzare questo sogno. Così ho abbandonato gli studi.
          <br />
          <br />
          ...
          che potesse dirmi come fare.
          <br />
          <br />
          Dopo molti errori e sforzi sono riuscito ad imparare a programmare e creare quello che sognavo (Westudents, un
          social che oggi ha quasi 500.000 utenti).
          <br />
          <br />
          Nel tempo grazie alla programmazione ho ricevuto offerte di lavoro da aziende come Google e lavorato per
          startup di successo.
          <br />
          <br />
          Da allora ho un solo obiettivo: aiutare le persone che vogliono imparare a programmare per cambiare la loro
