    ...
    <section id='what-is' className='pt-32' aria-label="Che cos'è Programmatore Leggendario">
      ...
      <div className='mx-auto max-w-2xl md:text-center'>
        ...
        <p className='mb-8 text-neutral-400 lg:text-xl'>
          Programmatore leggendario è un corso di Matteo Giardino per imparare a programmare e sviluppare la mentalità
          del programmatore di successo. Comprende 45+ lezioni interattive, 35+ sfide e progetti reali, un certificato,
          una community e molto altro.
        </p>
      </div>
