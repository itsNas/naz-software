    ...
    <section id='what-is-included' className='space-y-12 pt-16 text-neutral-400 sm:text-lg lg:pt-24'>
      <div className='max-w-3xl'>
        ...
        <p className='font-light lg:text-xl'>
          Con Programmatore Leggendario non impari solo a programmare, ottieni tutto ciò di cui hai bisogno per
          diventare un programmatore esperto.
        </p>
      </div>
          ...
          <ul className='space-y-5'>
            {included.map((feature) => (
              <li className={"flex space-x-3"} key={feature}>
                ...
                <span className='text-base font-medium leading-tight text-neutral-900 dark:text-white'>{feature}</span>
              </li>
            ))}
          </ul>
