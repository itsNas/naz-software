        ...
        <figcaption className='flex items-center space-x-4'>
          <div className='flex-none'>
            <div className='flex size-10 items-center justify-center rounded-xl bg-neutral-800'>
              <testimonial.icon className='size-7 text-yellow-400' size={48} strokeWidth={2} aria-hidden='true' />
            </div>
          </div>
          <div className='flex'>
  ...
  return (
    <section id='tech-knowledge' className='pt-32'>
      ...
      <div className='mx-auto mb-12 max-w-2xl md:mb-16 md:text-center'>
        ...
        <p className=' text-neutral-400 lg:text-xl'>Ecco alcune delle fondamenta della programmazione che tratteremo</p>
      </div>
