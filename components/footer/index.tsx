          ...
          <div className='grid w-full grid-cols-2 gap-2 sm:grid-cols-4'>
            {products.map((p) => (
              <Link
                ...
                <Image src={p.imageDark} height={80} width={100} alt={p.title} className='hidden dark:hidden' />
              </Link>
            ))}
          </div>
        </div>
        ...
        <div className='mb-10 hidden flex-col items-start gap-4 pr-4 md:flex'>
          {products.map((p) => (
            <Link
              ...
              <Image src={p.imageDark} height={80} width={100} alt={p.title} className='hidden dark:block' />
            </Link>
          ))}
        </div>
      </div>
