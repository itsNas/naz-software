    ...
    <section id='mentor' className='lg:pt-8'>
      ...
      <div className='flex flex-col justify-between md:flex-row'>
        <p className='my-8 text-gray-600 dark:text-gray-400 md:w-6/12 lg:text-xl'>
          ...
          <br />
          <br />
          È stato il periodo più difficile della mia vita, perché non avevo una guida, un percorso da seguire, nessuno
          che potesse dirmi come fare carriera. Dopo molti errori e sforzi sono riuscito a creare quello che sognavo.
          <br />
          <br />
          Ho ricevuto offerte di lavoro da aziende come Google e lavorato per startup di successo come Mia Platform.
          <br />
          <br />
          Oggi sono un ingegnere del software e un imprenditore. Per le mie aziende, faccio decine di colloqui al mese e
          conosco permettamente le caratteristiche di un buon candidato.
        </p>
          ...
          <ol className='relative ml-2 border-l border-gray-200 dark:border-gray-700'>
            {personalAchievements.map((achievement) => (
              <li className='mb-8 ml-6' key={achievement.title}>
                ...
                <h3 className='mb-1 text-lg font-semibold text-gray-900 dark:text-white'>{achievement.title}</h3>
                <p className='text-base font-normal text-gray-500 dark:text-gray-400'>{achievement.subtitle}</p>
              </li>
            ))}
          </ol>
          <p className='text-gray-600 dark:text-gray-400 lg:text-xl'>
            Con questo percorso voglio svelati i segreti del settore e permetterti di raggiungere i tuoi obiettivi
            professionali.
            <br />
          </p>
        </div>
