    ...
    <section id='what-is-included' className='space-y-12 py-16 text-gray-400 sm:text-lg lg:py-24'>
      <div className='max-w-3xl'>
        ...
        <p className='font-light lg:text-xl'>
          Con Tech Career Launch, avrai accesso a un pacchetto completo di servizi e strumenti che ti supporteranno in
          ogni fase del tuo percorso di avvio della carriera nel settore tech.
        </p>
      </div>
