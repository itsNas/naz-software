    ...
    <section id='what-is' className='pt-32' aria-label="Che cos'è Tech Career Launch">
      ...
      <div className='mx-auto max-w-2xl md:text-center'>
        ...
        <p className='mb-8 text-gray-400 lg:text-xl'>
          Tech Career Launch è un percorso di 4 settimane con Matteo Giardino, un mentore esperto che ti fornirà
          consigli pratici, orientamento strategico e supporto personalizzato per superare i colloqui di lavoro.
        </p>
      </div>
        ...
        <div className='grid grid-cols-1 gap-x-8 gap-y-12 md:grid-cols-3'>
          ...
          <div className='flex flex-col justify-items-center'>
            <div className='flex items-end gap-4 md:flex-col md:items-center'>
              ...
              <h3 className='text-xl font-semibold  text-purple-400 md:text-center'>Preparazione e Pratica</h3>
            </div>
