    ...
    <section id='solution' className='pt-16 text-gray-400 sm:text-lg lg:pb-8 lg:pt-24'>
      <div className='max-w-3xl'>
        ...
        <p className='mt-4 font-light lg:text-xl'>
          Attraverso a sessioni personalizzate e pratica, ti prepareremo a superare i colloqui di lavoro e a raggiungere
          tuoi obiettivi professionali. Riceverai consigli pratici, strategie efficaci e supporto personalizzato che ti
          daranno un vantaggio competitivo nel mondo del lavoro.
        </p>
      </div>
      ...
      <div className='mt-12 items-center gap-8 md:grid md:grid-cols-2 md:gap-8'>
        ...
        <Image className='m-auto hidden w-[90%] md:flex lg:mb-0' src={SectionImage} alt='Solution features image' />
      </div>
    </section>
  )
}
