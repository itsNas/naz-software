    ...
    <section id='problem' className='border-b border-gray-700 pb-16 md:pt-8 lg:pb-24'>
      ...
      <div className='mt-8 flex flex-col justify-between sm:flex-row'>
        <p className='font-light text-gray-400 sm:w-8/12 lg:text-xl'>
          Il 96% dei neolaureati e degli aspiranti programmatori si trova completamente impreparato quando deve
          affrontare i colloqui di lavoro. <br /> <br /> Sono confusi, incerti e disorientati. È comprensibile dato che
          nessuno li ha mai istruiti su come comportarsi.
        ...
        {problemBulletPoints.map((bulletPoint) => (
          <li className='mr-5 flex flex-col sm:inline-block' key={bulletPoint}>
            <div className='flex space-x-2'>
              ...
              <span className='text-base font-medium leading-tight text-gray-900 dark:text-white'>{bulletPoint}</span>
            </div>
          </li>
        ))}
      </ul>
