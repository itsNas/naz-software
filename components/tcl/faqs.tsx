...
const FAQList = [
  ...
  },
  {
    ...
    answer:
      "I posti disponibili per il percorso di mentorship Tech Career Launch sono 50. Sono circa il doppio rispetto alla prima edizione, che aveva solo 25 posti disponibili. Nonostante il notevole aumento, i posti sono comunque limitati e vanno via rapidamente, quindi affrettati!",
  },
  {
    question: "Cosa significa mentoring 1-1?",
    answer:
      "Il percorso fornisce sessioni di dialogo individuali con il mentore, Matteo Giardino. Questo tipo di mentoring si svolge in un contesto one-on-one, in cui il mentore lavora direttamente con il partecipante, offrendo supporto personalizzato, consigli e orientamento basati sulle esigenze specifiche del partecipante.",
  },
  {
    question: "Quanto durano delle sessioni di mentoring?",
    answer:
      "La durata delle sessioni di mentoring può variare a seconda delle preferenze del partecipante e delle necessità specifiche. Di solito, una sessione di mentoring può durare da 30 minuti a un'ora.",
  },
  {
    question: "Quali sono i benefici di partecipare a Tech Career Launch?",
    answer:
      "Partecipando a Tech Career Launch, avrai accesso a mentoring personalizzato, consigli pratici, orientamento strategico, risorse per lo sviluppo delle competenze, preparazione per i colloqui di lavoro e opportunità di networking professionale.",
  },
  {
    question: "Come avvengono le sessioni di mentoring?",
    answer:
      "Le sessioni di mentoring possono svolgersi online o di persona, a seconda delle preferenze del partecipante e del mentore. Se le sessioni si svolgono online, di solito avvengono tramite videochiamate o piattaforme di comunicazione online.",
  },
  {
    question: "Cosa succede quando pago?",
    answer:
      "Quando paghi per il percorso di mentorship Tech Career Launch, riceverai una conferma di pagamento e ulteriori informazioni sulle modalità di accesso alle sessioni di mentoring. È importante seguire le istruzioni fornite dopo il pagamento per assicurarsi di ottenere tutti i benefici offerti dal percorso di mentorship.",
  },
  {
    question: "Quali competenze posso sviluppare durante il percorso di mentorship?",
    answer:
      "Durante il percorso di mentorship, potrai sviluppare competenze tecniche nel campo della programmazione, migliorare le tue abilità di presentazione e comunicazione, acquisire conoscenze sulle dinamiche del mondo del lavoro e altro ancora.",
  },
  {
  ...
  return (
    <section id='faq' className='my-24 flex flex-col gap-12 lg:flex-row'>
      <div className='text-center lg:w-5/12 lg:text-left'>
        <h2 className='text-2xl font-bold text-gray-800 dark:text-white md:text-3xl lg:text-4xl'>Domande frequenti</h2>
