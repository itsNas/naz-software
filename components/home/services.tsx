      ...
      <div className='flex flex-col items-start justify-between gap-4 md:flex-row md:items-end'>
        <div className='flex-auto'>
          <h2 className='text-3xl font-bold'>
            come aiuto <strong className='underline decoration-sky-400 underline-offset-4'>aziende</strong> e{" "}
            <strong className='underline decoration-sky-400 underline-offset-4'>imprenditori</strong>
          </h2>
