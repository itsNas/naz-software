        ...
        <div className='mx-auto max-w-7xl pb-8 lg:px-8'>
          <div className='max-w-2xl lg:mx-auto lg:text-center'>
            ...
            <p className='mt-6 text-lg leading-8 text-muted-foreground dark:text-gray-300'>
              ho avuto la fortuna di conoscere grandi persone con grandi idee. A tutte però mancava una cosa: la
              conoscenza tecnologica necessaria per sbloccare il pieno potenziale. Voglio dare la direzione necessaria
              per aiutare un imprenditore a raggiungere qualsiasi tipo di successo.
            </p>
          </div>
        </div>
      </section>
